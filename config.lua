	...
	maxPlayers = 800
	motd = "Bem Vindo ao Melhor Baiak Zik VIP 15 Editado por DeathRocks Tibiking"
	displayOnOrOffAtCharlist = false
	onePlayerOnlinePerAccount = true
	allowClones = false
	serverName = "Baiak Zik"
	loginMessage = "Voce esta Jogando o Melhor Baiak Zik com Vip 15 e com Castle 24Horas"
