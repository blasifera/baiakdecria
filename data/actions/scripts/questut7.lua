...
storage = 938320 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 12387 -- Id do item ira ganhar.
...
doPlayerSendTextMessage(cid,25,"Você ganhou um Paladin Ring") -- Mensagem que aparecera quando ganhar o item.
