...
doPlayerSendTextMessage(cid,22,"Você ganhou 30 dias de donate.")

doPlayerAddItem(cid,10309,1)

elseif r1 == 3 then

doPlayerSendTextMessage(cid,22,"Você ganhou uma Supreme Vip.")
...
doPlayerSendTextMessage(cid,22,"Você ganhou um Card Exp 5x.")
